 ...
 // }
  ...
  //}
   ...
   function accounteCondition (){
    ...
    let restriction = confirm('Only Institutions are supposed to create an accounte! Members  can sign in with the details their Intitution attributed to them ! If you are an Intstitution, click ok to proceed!');
